...
import {resetPoints, resetRound, resetHealth, addLeader, resetInventory } from '../Actions/index'
...
function Game() {
    ...
    const resetInventoryAC = bindActionCreators(resetInventory, dispatch)

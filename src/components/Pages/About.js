...
function About() {
    ...
    return (
        <div>
            ...
            <h5>This is a game I built based on a one-shot about my time working in a grocery store. </h5>
                {/* If you're interested in playing, it's available <a href='https://github.com/JillKlatt'>here </a> */}
